...
//
//import com.maps.Utility.EncryptionUtil;
...
//	public ResponseEntity<JwtResponse> createAuthenticationToken(@RequestHeader(value = "USER_TYPE", required = false) String userType, @RequestBody JwtRequest loginRequest)
//			throws Exception {
//
...
//		
//		userService.canUserLogin(loginRequest.getUserId());// login parameters check
//
...
//
//		try {			
//			String cancatedUserInstIdUserType = null;
//			if (jwtRequest.getMerchId() != null) {
//			 cancatedUserInstIdUserType = String.format("%s|%s|%s|%s", 
//					jwtRequest.getUserId(),jwtRequest.getInstId(),jwtRequest.getMerchId(),jwtRequest.getUserType());
//			}
//			else {
//				cancatedUserInstIdUserType = String.format("%s|%s|%s", 
//					jwtRequest.getUserId(),jwtRequest.getInstId(),jwtRequest.getUserType());
//				}
//			return authenticationManager.authenticate(
//				new UsernamePasswordAuthenticationToken(cancatedUserInstIdUserType, jwtRequest.getPassword()));
//		} catch (DisabledException e) {
//			throw new ApplicationException("USER_DISABLED", e);
//		} catch (BadCredentialsException e) {
//			userService.setBlock(jwtRequest.getUserId());
//			
